...
class Test_parse_definition_line:
    def test_definition_line_id_and_description_good(
        self, definition_line_test_function
    ):
        ...
        # without '>'
        definition_line_test_function(
            definition_line[1:], "ID123|moreID", "description and more text"
        )
        # long space before description
        definition_line_test_function(
            "id              description abc", "id", "description abc"
        )
    ...
    def test_definition_line_id(self, definition_line_test_function):
        ...
        # space after id
        definition_line_test_function(
            definition_line[1:] + "   ", "ID123|secondID|otherID", ""
        )
