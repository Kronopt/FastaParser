...
@pytest.fixture(scope='module')
def nucleotide_letter_codes_all(nucleotide_letter_codes_good, nucleotide_letter_codes_degenerate):
    return set(
...
@pytest.fixture(scope='module')
def aminoacid_letter_codes_all(aminoacid_letter_codes_good, aminoacid_letter_codes_degenerate):
    return set(
